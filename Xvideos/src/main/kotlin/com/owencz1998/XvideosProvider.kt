...
"BBW"),
        Pair("$mainUrl/c/?k=wife&top/",
"Wife"),
        Pair("$mainUrl/c/redhead-31/",
"Redhead"),
        Pair("$mainUrl/c/?k=rough&top/",
"Rough"),
        Pair("$mainUrl/c/stocking-28/",
"Stockings"),
        Pair("$mainUrl/c/?k=teacher&top/",
"Teacher"),
        Pair("$mainUrl/c/gay?fmc=1/",
"Gay"),
        Pair("$mainUrl/c/?k=vintage&top/",
"Vintage"),
        Pair("$mainUrl/c/?k=real&top/",
"Real"),   
        Pair("$mainUrl/c/?k=joi&top/",
"Joi"),
       Pair("$mainUrl/c/interracial-27/",
"Interracial"),
       Pair("$mainUrl/c/?k=hardcore&top/",
"Hardcore"),         
